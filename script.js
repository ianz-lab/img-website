...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        en: {
            ...
            'hero.subtitle': 'Uluslararası yatırımcılara yalnızca fırsatlar sunmakla kalmıyor; ABD’deki yatırımlarının planlama, uygulama ve büyüme aşamalarının tamamında rehberlik ediyoruz.'t just open doors, we guide international buyers through every step of U.S. real estate ownership.',
        ...
        tr: {
            ...
            'hero.subtitle': 'Uluslararası yatırımcılara yalnızca fırsatlar sunmakla kalmıyor; ABD’deki yatırımlarının planlama, uygulama ve büyüme aşamalarının tamamında rehberlik ediyoruz.'de mülk sahibi olma yolculuğunun her adımında rehberlik ediyoruz.',
