...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        ...
        tr: {
            ...
            'stats.subtitle': 'Amerika Birleşik Devletleri, dünyanın en güvenli ve en karlı gayrimenkul pazarlarından biri olmaya devam ediyor Çok az ülkenin sunabileceği istikrar, şeffaflık ve uzun vadeli büyüme potansiyeli sunuyor.',
            ...
            'whyUs.feature1Expanded': 'Biz sadece emlak danışmanları değiliz; ABD’de gayrimenkul sahibi olma sürecinin her aşamasında yanınızda olan stratejik iş ortaklarınızız.\n\nYatırımcı hizmetlerimiz, uluslararası alıcılara ABD’de sorunsuz ve güvenli bir gayrimenkul deneyimi sunmak üzere tasarlanmıştır. Biz sadece işlemleri yönetmiyor, insanlara rehberlik ediyoruz. \n\nHer müşterinin hikâyesi kendine özgüdür; bu nedenle doğru yolu birlikte belirlemeden önce hedeflerinizi, endişelerinizi ve vizyonunuzu anlamaya zaman ayırıyoruz.',
